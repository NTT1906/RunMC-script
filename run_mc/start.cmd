...
if exist run_mc\start_mc.cmd (
	rem call run_mc\start_mc.cmd " would start within a single terminal
...
if exist run_mc\SingletonRun.php (	
	%PHP_BINARY% run_mc\SingletonRun.php
)
